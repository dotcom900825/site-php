...
<head>
	...
	<meta property="og:title" content="iPassStore - University of Chicago Chinese Student & Scholars Association"/>
	<meta property="og:type"  content="website" /> 
	<meta property="og:url" content="https://www.ipassstore.com/Client/UChicago_CSSA_Membership_Card/"/>
	<meta property="og:image" content="https://www.ipassstore.com/resource/image/iPassStore_icon.png"/>
	<meta property="og:description" content="University of Chicago CSSA Digital Membership Card Program"/>


	<!-- * Title-->
	<title>iPassStore - University of Chicago Chinese Student & Scholars Association</title>
...
<section id="content">
	...
	<section id="product-info" class="collection">
		<header>
			<h2>University of Chicago Chinese Student & Scholars Association</h2>
		</header>
		...
		<div class="product-info-wrapper stacks">
			<article>
				...
				<div class='social_box'>
					...
					<div class="fb-like" data-href="https://www.ipassstore.com/Client/UChicago_CSSA_Membership_Card/" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false"></div>
				
					<!-- * Twitter Tweet Button-->
					<div class='twitter'><a href="http://twitter.com/share" data-url="https://www.ipassstore.com/Client/UChicago_CSSA_Membership_Card/" class="twitter-share-button" data-text="@iPassStore - Fill your Passbook and Stay Connected. Check it out: iPassStore.com" data-count="horizontal">&nbsp;</a>
			...
			<!-- * Comment Box -->
			<script src="comments/backsnap/assets/js/backsnap.js" data-backsnap-path="comments"  data-backsnap-page="UChicagoCSSA"></script>	
