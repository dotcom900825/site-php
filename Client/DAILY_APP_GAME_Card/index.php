...
<head>
	...
	<meta property="og:title" content="iPassStore - Free App of the Day"/>
	<meta property="og:type"  content="website" /> 
	<meta property="og:url" content="https://www.ipassstore.com/Client/DAILY_APP_GAME_Card/"/>
	<meta property="og:image" content="https://www.ipassstore.com/resource/image/iPassStore_icon.png"/>
	<meta property="og:description" content="Get the Best Paid Apps for Free Daily! No Gimmicks, No Strings Attached. Paid Apps For Free For You to Keep Forever!"/>


	<!-- * Title-->
	<title>iPassStore - Free App of the Day</title>
		...
		<div class="product-info-wrapper stacks">
			<article>
				<aside>
					...
					<ul class="metadata">
						<li><strong>Release Date:</strong> July 20, 2013</li>
						...
						<li>
							...
							<a href="" title="View Similar Cards">Entertainment</a>
						</li>
				...
				<div class="description summary">
					...
					<p>Get the Best Paid Apps for Free Daily! No Gimmicks, No Strings Attached. Paid Apps For Free For You to Keep Forever!</p>
				...
				<div class='social_box'>
					...
					<div class="fb-like" data-href="https://www.ipassstore.com/Client/DAILY_APP_GAME_Card/" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false"></div>
				
					<!-- * Twitter Tweet Button-->
					<div class='twitter'><a href="http://twitter.com/share" data-url="https://www.ipassstore.com/Client/DAILY_APP_GAME_Card/" class="twitter-share-button" data-text="@iPassStore - Fill your Passbook and Stay Connected. Check it out: iPassStore.com" data-count="horizontal">&nbsp;</a>
			...
			<!-- * Comment Box -->
			<script src="comments/backsnap/assets/js/backsnap.js" data-backsnap-path="comments"  data-backsnap-page="DailyFreeApp"></script>	
...
<li>
	<div class="wrapper stacks">
		...
		<footer>
			<nav>
				<ul>
					<li><a href="" title="Buy some advertising space">Advertise</a></li>
