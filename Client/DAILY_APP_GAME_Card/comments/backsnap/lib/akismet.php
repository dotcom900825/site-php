...
class Akismet {
	 ...
	 * @param	string	$akismetAPIKey	WordPress API key.
	 */
	...
	public function isCommentSpam() {
		...
		if($response[1] == 'invalid' && !$this->isKeyValid()) {
			throw new exception('The Akismet API key passed to the Akismet constructor is invalid.  Please obtain a valid one from http://wordpress.com/api-keys/');
		}
