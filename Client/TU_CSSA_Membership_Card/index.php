...
<head>
	...
	<meta property="og:title" content="iPassStore - Tulane Chinese Student & Scholars Association"/>
	<meta property="og:type"  content="website" /> 
	<meta property="og:url" content="https://www.ipassstore.com/Client/TU_CSSA_Membership_Card/"/>
	<meta property="og:image" content="https://www.ipassstore.com/resource/image/iPassStore_icon.png"/>
	<meta property="og:description" content="Tulane University CSSA Digital Membership Card Program"/>


	<!-- * Title-->
	<title>iPassStore - Tulane Chinese Student & Scholars Association</title>
...
<section id="content">
	...
	<section id="product-info" class="collection">
		<header>
			<h2>Tulane Chinese Student & Scholars Association</h2>
		</header>
		...
		<div class="product-info-wrapper stacks">
			<article>
				<aside>
					...
					<ul class="metadata">
						...
						<li>
							...
							<a href="" title="View Similar Cards">Student Organization</a>
						</li>
						
					</ul>
				</aside>
				<div class="description summary">
					<h2>TCSSA Digital Membership Card</h2>
					...
					<p>TCSSA is a student-run organization whose mission is to broaden the channels of communication between the Tulane Chinese community and various other cultural, academic, and professional communities in the Great New Orleans Area. <br/><br/>
					   
					   With TCSSA Digital Membership Card, members can get latest event information, announcements as well as discount updates for membership card holders in time.</p>
				...
				<div class='social_box'>
					...
					<div class="fb-like" data-href="https://www.ipassstore.com/Client/TU_CSSA_Membership_Card/" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false"></div>
				
					<!-- * Twitter Tweet Button-->
					<div class='twitter'><a href="http://twitter.com/share" data-url="https://www.ipassstore.com/Client/TU_CSSA_Membership_Card/" class="twitter-share-button" data-text="@iPassStore - Fill your Passbook and Stay Connected. Check it out: iPassStore.com" data-count="horizontal">&nbsp;</a>
			...
			<!-- * Comment Box -->
			<script src="comments/backsnap/assets/js/backsnap.js" data-backsnap-path="comments"  data-backsnap-page="TUCSSA"></script>	
...
<li>
	<div class="wrapper stacks">
		<a href="https://www.ipassstore.com/Client/DAILY_APP_GAME_Card/" title="Find out more about Free App of the Day">
			<img src="Client/DAILY_APP_GAME_Card/pass/source/logo@2x.png" width="48" height="48" />
