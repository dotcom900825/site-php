...
<div class="absolute-wrapper-outer">
    ...
    <div id="storecard-front-lengend-wrapper" class="absolute-wrapper-inner" style="display:none;">
        <div id="logo-wrapper">
    ...
    <div id="storecard-back-wrapper" class="form-horizontal">
        <?php
        ...
        <hr/>
        <button class="btn btn-primary form-operation" type="button" id="add_content_group" onclick="addContentGroup()">
            Add Content Group
        </button>
    </div>
