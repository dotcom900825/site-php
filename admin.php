...
<head>
    ...
    <script type="text/javascript" src="src/scripts/brick-1.0beta6.byob.min.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="src/style/brick-1.0beta6.byob.min.css"/>
